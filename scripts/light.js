...
/* global doorLight, Porta_Chiusa, light, Porta1, THREE, wall_material */
var torch_y = 3.5;
...
function spotLightPlacing() {
    ...
    doorLight.position.set(15, 3.5, 8.64);
    ...
    // add spot light
    var geometry = new THREE.CylinderGeometry(0.1, 1, 5, 32 * 2, 20, true);

    var material = new THREEx.VolumetricSpotLightMaterial();
    var mesh = new THREE.Mesh(geometry, material);
    mesh.position.set(doorLight.position.x - (geometry.parameters.height / 2), doorLight.position.y - 1, doorLight.position.z);
